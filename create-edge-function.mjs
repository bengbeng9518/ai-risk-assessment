...
const code = `export async function onRequestPost(context) {
...
const dir = 'edge-functions/api/ai';
if (!existsSync(dir)) {
  mkdirSync(dir, { recursive: true });
}
writeFileSync('edge-functions/api/ai/analyze.js', code);
console.log('Created edge-functions/api/ai/analyze.js');
